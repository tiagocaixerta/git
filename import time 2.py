...
# Criar CSV com cabeçalho (caso não exista)
def initialize_csv():
    with open(CSV_FILE, mode='w', newline='', encoding='utf-8') as file:
        writer = csv.writer(file)
        writer.writerow(["Título", "Data de Lançamento", "Classificação", "Sinopse"])  # Cabeçalho
...
def main():
    ...
    initialize_csv()  # Criar o arquivo CSV com cabeçalho antes de salvar os filmes
